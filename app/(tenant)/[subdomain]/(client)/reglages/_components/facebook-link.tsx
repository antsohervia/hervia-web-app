...
export function FacebookLink({ linked }: { linked: boolean }) {
  ...
  return (
    <div className="space-y-3">
      ...
      <p className="text-sm text-muted-foreground">
        Liez votre compte Facebook pour vous connecter plus facilement.
      </p>
      <Button
        type="button"
        variant="outline"
      ...
      >
        {pending ? "Redirection…" : "Lier avec Facebook"}
      </Button>
    </div>
  );
}
